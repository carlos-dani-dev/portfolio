export default {
    ...
    projects_locale: {
        ...
        items: {
            ...
            portfolio: {
                ...
                description: "My **fully responsive** professional portfolio, developed with **Vue** and **Tailwind** and cached using **Pinia** for language and theme control.",
            }
        }
    },
    experiences: {
    ...
    resume: {
        ...
        exp_1_bullet_2: "Processing raw data and composing **key performance indicators (KPIs)**",
        exp_1_bullet_3: "Serving transformed data with **Python** through a **FastAPI** API for insights consumption and provisioning in **Metabase**",
        exp_2_role: "Researcher — DeepFake Detection",
        exp_2_company: "LabVip, UFPI",
        exp_2_period: "Sep 2024 — Present",
        exp_2_bullet_1: "Reviewing and analyzing scientific papers in English",
        exp_2_bullet_2: "Transforming and preparing model image datasets with **Python**",
        exp_2_bullet_3: "Implementing a **Dense Neural Network (DNN)** from scratch with **TensorFlow**, following the **MAAD-Face: A Massively Annotated Attribute Dataset for Face Images** paper",
        exp_2_bullet_4: "Optimizing GPU training scripts and actively maintaining the lab's **Linux** machines",
        exp_3_role: "Administrative Intern",
        exp_3_company: "People Development Department (SEAD)",
        exp_3_period: "Apr 2024 — Apr 2026",
        exp_3_bullet_1: "Handling administrative processes in **SEI**",
        exp_3_bullet_2: "Analyzing employee data available in the SEI platform by providing insights with **Power BI**",
        exp_3_bullet_3: "Automating the extraction of decrees and appointments from the official **DOEPI** website using **Selenium** and the **Google Gemini** API",
        exp_3_bullet_4: "Semi-automating contract addenda generation using **Google Workspace**",
        education_title: "EDUCATION",
        education_degree: "Bachelor of Science in Computer Science",
        education_institution: "Federal University of Piauí — UFPI",
        education_period: "Jun 2022 — Present",
        languages_title: "LANGUAGES",
        language_1: "**Advanced English** — listening, reading, and technical writing proficiency",
        language_2: "**Portuguese** — native",
        projects_title: "PROJECTS",
        project_1: "**Responsive WorldCup Chatbot Web** - **FastAPI**, **Vue.js**, **PostgreSQL**, **Tailwind**",
        project_2: "**Responsive Web Form** - **FastAPI**, **PostgreSQL**, **Jinja**, **Bootstrap**",
        project_3: "**Massive Attribute Classifier** (DNN) - **TensorFlow**, **Pandas**",
